...
class Datapaket_model extends CI_Model
{
	...
	{
		$chart = $this->db->query("SELECT a.sub_jenis , count(b.nama_paket)jumlah FROM tbl_jenis a ,tbl_paket b WHERE b.id_jenis = a.id_jenis and b.id_tahun = '$id_tahun' GROUP by b.id_jenis");
		return $chart->result();
	}
	...
	{
		$query = $this->db->query("SELECT b.id_tahun,b.id_jenis,b.id_paket, a.nama_tahun, b.nama_paket, c.main_jenis, c.sub_jenis , b.input_by from tbl_tahun a , tbl_paket b , tbl_jenis c WHERE b.id_tahun = a.id_tahun and b.id_jenis = c.id_jenis AND b.id_paket ='$id_paket'");
		return $query->result_array();
	}
