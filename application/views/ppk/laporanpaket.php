                        ...
                        <tbody>
                            ...
                            <tr style="font-size: 13px;">
                                <td style="font-weight: 600;" colspan="3" class="col-tosca">
                                   Tahun : <?php echo $data_tahun['nama_tahun'] ?>
                                </td>
                                <td style="font-weight: 600;" class="col-tosca" style="padding: 20px;" colspan="1">
                                   <p style="float: right;">Jenis Paket : <?php echo ucwords($where_jenis['main_jenis']) ?></p>
                                </td>
                            </tr>
                            <tr style="font-size: 13px;">
                                <td style="font-weight: 600;" class="col-tosca" style="padding: 20px;" colspan="1">
                                   <p style="float: right;">Sub Jenis Paket : <?php echo ucwords($where_jenis['sub_jenis']) ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
