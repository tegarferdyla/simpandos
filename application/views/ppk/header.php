...
<head>
  ...
  <!-- END Custom CSS-->
  <!-- BOOTSTRAP VALIDATOR -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('app-assets/css/validator/bootstrapValidator.css') ?>">
</head>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="avatar avatar-online">
                  <img src="<?php echo base_url('app-assets/images/users/'.$data_user['foto']) ?>" alt="avatar"><i></i></span>
                <span class="user-name"><?php echo $data_user['nama_user']; ?></span>
              </a>
