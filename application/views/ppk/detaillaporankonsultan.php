                    ...
                    <table width="100% isi-laporan">
                        <tbody>
                            ...
                            <tr style="font-size: 13px;" class="bg-grey">
                                ...
                                <td class="p-10">Laporan Pendahuluan</td>
                            ...
                            <tr style="font-size: 13px;" class="bg-grey">
                                ...
                                <td class="p-10">Laporan Antara</td>
                            ...
                            <tr style="font-size: 13px;" class="bg-grey">
                                ...
                                <td class="p-10">Draft Laporan Akhir</td>
                                <?php if (!empty($file_dla)): ?>
                                    <td class="p-10">
                                        <?php foreach ($file_dla as $u) { ?>
                                                <li><?php echo $u['nama_file']?></li>
                                            </ul>
                                        <?php } ?>
                                    </td>
                            ...
                            <tr style="font-size: 13px;" class="bg-grey">
                                ...
                                <td class="p-10">Laporan Akhir</td>
