    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title mb-0">Input Sub Kepala Dokumen </h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo site_url('admin') ?>">Dashboard</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">Input Sub Kepala Dokumen</a>
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form class="form form-horizontal" action="<?php echo base_url('admin/tambahsubkepala') ?>" method="post">
                      <div class="form-body">
                        <h4 class="form-section"><i class="ft-bookmark"></i> Sub Kepala Dokumen </h4>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            ...
                            name="subkepala" required>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-md-3 label-control" for="projectinput1">Kepala Dokumen</label>
                          <div class="col-md-9">
                           <select name="kepala_dok" id="" class="form-control" required>
                           	<option value="">--- Pilih Kepala Dokumen --- </option>
